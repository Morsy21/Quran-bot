...
def add_text_to_image(img_path: str, text: str, out_path: str, font_size: int = 52) -> str:
...
def create_video(audio_path: str, image_paths: list, ayah_text: str, output_path: str) -> str:
    ...
    clips = [ImageClip(p).set_duration(per_img).resize(height=720) for p in tmp_imgs]
...
def main():
    ...
    conv = ConversationHandler(
        ...
        states={
            ...
            WAIT_IMAGES: [MessageHandler(filters.PHOTO | filters.Document.IMAGE, receive_image), CommandHandler("done", images_done)],
